...
const TESTIMONIALS = [
  {
    ...
    content:
      "The quality of Lumina products is unmatched. Every piece I've purchased feels carefully crafted and built to last.",
    avatar: "SJ",
  },
  {
    name: "Michael Chen",
    ...
    content:
      "Minimalism done right. Lumina has become my go-to for both office and personal lifestyle essentials.",
    avatar: "MC",
  },
  {
    name: "Emma Williams",
    ...
    content:
      "Fast delivery and exceptional customer service. The Silence Pro headphones are a total game changer for my daily commute.",
    avatar: "EW",
  },
];
      ...
      <main className="flex-1 pb-20">
          ...
          <div className="embla" ref={emblaRef}>
            <div className="embla__container flex">
              {HERO_SLIDES.map((slide, index) => (
                <div
                  key={index}
                  className="embla__slide flex-[0_0_100%] relative h-[500px] md:h-[700px]"
                >
                  <img
                    src={slide.image}
                    alt={slide.title}
                  ...
                  <div className="container mx-auto px-4 h-full flex flex-col justify-center relative z-20">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-4">
                        <Button
                          size="lg"
                          className="bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold px-8 rounded-full h-14"
                        >
                          {slide.cta}
                        </Button>
                        <Button
                          size="lg"
                          variant="outline"
                          className="text-white border-white/30 hover:bg-white/10 rounded-full h-14 px-8"
                        >
                          View Lookbook
                        </Button>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="font-bold text-xl mb-6 flex items-center gap-2">
                <TrendingUp className="text-secondary h-5 w-5" /> Summer
                Essentials
              </h3>
              <div className="grid grid-cols-2 gap-4 flex-1">
                <div className="aspect-square bg-muted rounded-xl overflow-hidden cursor-pointer">
                  <img
                    src="/src/assets/images/product-sunglasses.jpg"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
                <div className="aspect-square bg-muted rounded-xl overflow-hidden cursor-pointer">
                  <img
                    src="/src/assets/images/product-backpack.jpg"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
              </div>
              <Link href="/">
                <a className="text-primary text-sm font-bold mt-6 flex items-center gap-2 hover:gap-3 transition-all">
            ...
            >
              ...
              <div className="aspect-[16/9] bg-muted rounded-xl overflow-hidden mb-6 relative">
                <img
                  src="/src/assets/images/product-headphones.jpg"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                />
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-sm text-white/70 mb-8 leading-relaxed">
                  Join 10M+ members and get free shipping, exclusive drops, and
                  premium streaming.
                </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Trending",
                desc: "Most popular now",
              },
              {
                icon: <Percent className="text-secondary" />,
                title: "Daily Deals",
                desc: "Up to 50% off",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="flex flex-col items-center text-center gap-4 p-6 rounded-2xl hover:bg-white transition-colors border border-transparent hover:border-border"
              >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
              <div className="max-w-xl text-white">
                ...
                <p className="text-white/60">
                  Experience the craftsmanship and detail of our latest releases
                  through cinematic highlights.
                </p>
              </div>
              <Button
                variant="link"
                className="text-white hover:text-secondary p-0 h-auto font-bold flex items-center gap-2"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              <div className="md:col-span-8 group relative rounded-3xl overflow-hidden aspect-video bg-muted border border-white/10">
                ...
                >
                  <source
                    src="/src/assets/videos/product-showcase.mp4"
                    type="video/mp4"
                  />
                </video>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-8">
                  <h3 className="text-white text-2xl font-bold mb-2">
                    Aura Series 3: The Design Process
                  </h3>
                  <div className="flex items-center gap-4">
                    <Button
                      size="icon"
                      className="rounded-full h-12 w-12 bg-white text-black hover:scale-110 transition-transform"
                    >
              ...
              <div className="md:col-span-4 flex flex-col gap-6">
                ...
                <div className="flex-1 bg-white/5 rounded-3xl p-6 border border-white/10 hover:bg-white/10 transition-colors cursor-pointer">
                  ...
                  <p className="text-white/40 text-sm mb-4">
                    Our journey to 100% recycled packaging by 2027.
                  </p>
                  <Button
                    variant="outline"
                    className="text-white border-white/20 hover:bg-white/10 w-full rounded-xl"
                  >
                    Watch Journey
                  </Button>
                </div>
        ...
        <section className="py-24 container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
              Loved by our Global Community
            </h2>
            <p className="text-muted-foreground italic">
              Join over 1,000,000+ satisfied customers worldwide who trust
              Lumina for their daily essentials.
            </p>
          </div>
        ...
        <section className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/">
              <a className="text-primary text-sm font-bold hover:underline flex items-center gap-2">
